<section class="text-gray-700 bg-white   bottom-0 w-full body-font" {!! $attributes ?? '' !!}>
    <div class="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
        <a href="{{ route('developers.index') }}"
            class="text-xl flex space-x-1  font-black leading-none text-white select-none logo"  wire:navigate><x-app-logo-icon
                class="w-8" />
        ...
        <span class="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
            ...
            <a href="https://www.instagram.com/arabhardware/?hl=en" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://www.tiktok.com/@arabhardware?lang=en" class="text-gray-400 hover:text-gray-500">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" aria-hidden="true" fill="currentColor"
                    id="icons" viewBox="0 0 512 512">
                    <path
