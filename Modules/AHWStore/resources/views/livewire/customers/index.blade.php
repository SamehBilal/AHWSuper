...
new #[Layout('ahwstore::components.layouts.master')] class extends Component {
    ...
    public function loadCustomersData()
    {
        try {
            ...
            $cacheKey = 'ahwstore_customers_data';
    ...
    public function refreshCustomers()
    {
        ...
        Cache::forget('ahwstore_customers_data');
        $this->loadCustomersData();
    ...
    public function viewCustomer($contactId)
    {
        ...
        // You can redirect to a view page: return redirect()->route('ahwstore.customers.show', $contactId);
    }
    ...
    public function editCustomer($contactId)
    {
        ...
        // You can redirect to an edit page: return redirect()->route('ahwstore.customers.edit', $contactId);
    }
