...
new class extends Component {
    ...
    public function loadInvoicesData()
    {
        try {
            ...
            $cacheKey = 'ahwstore_invoices_data';
    ...
    public function refreshInvoices()
    {
        ...
        Cache::forget('ahwstore_invoices_data');
        $this->loadInvoicesData();
    ...
    public function viewInvoice($invoiceId)
    {
        ...
        // You can redirect to a view page: return redirect()->route('ahwstore.invoices.show', $invoiceId);
    }
    ...
    public function editInvoice($invoiceId)
    {
        ...
        // You can redirect to an edit page: return redirect()->route('ahwstore.invoices.edit', $invoiceId);
    }
