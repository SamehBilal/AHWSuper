...
namespace Modules\AHWStore\Providers;
...
class AHWStoreServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'AHWStore';

    protected string $nameLower = 'ahwstore';
