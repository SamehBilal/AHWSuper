...
class SalesOrdersController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/v1/ahwstore/sales-orders",
     *     tags={"SalesOrders"},
    ...
    /**
     * @OA\Get(
     *     path="/api/v1/ahwstore/sales-orders/{id}",
     *     tags={"SalesOrders"},
    ...
    /**
     * @OA\Post(
     *     path="/api/v1/ahwstore/sales-orders/{id}/status/confirmed",
     *     tags={"SalesOrders"},
    ...
    /**
     * @OA\Post(
     *     path="/api/v1/ahwstore/sales-orders/{id}/status/void",
     *     tags={"SalesOrders"},
    ...
    /**
     * @OA\Post(
     *     path="/api/v1/ahwstore/sales-orders/status/confirmed",
     *     tags={"SalesOrders"},
