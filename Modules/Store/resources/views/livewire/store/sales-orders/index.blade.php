...
new #[Layout('store::components.layouts.admin', ['pageTitle' => 'Arabhardware | App Testers'])] class extends Component {
    ...
    public function loadSalesOrdersData()
    {
        try {
            ...
            $cacheKey = 'store_sales_orders_data_' . $this->page . '_' . $this->perPage . '_' . md5($this->search);
    ...
    public function viewOrder($orderId)
    {
        ...
        // You can redirect to a view page: return redirect()->route('store.sales-orders.show', $orderId);
    }
    ...
    public function editOrder($orderId)
    {
        ...
        // You can redirect to an edit page: return redirect()->route('store.sales-orders.edit', $orderId);
    }
    ...
    <section class="w-full">
        <x-mary-header icon="o-shopping-cart" icon-classes="bg-primary text-white rounded-full p-1 w-6 h-6" title="Sales Orders"
            ...
            <x-slot:actions>
                ...
                <x-mary-button link="{{ route('store.sales-orders.create') }}" icon="o-plus" class="btn-primary btn-sm" />
            </x-slot:actions>
        </x-mary-header>
