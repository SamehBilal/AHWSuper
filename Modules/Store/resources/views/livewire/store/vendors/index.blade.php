...
new #[Layout('store::components.layouts.admin', ['pageTitle' => 'Arabhardware | App Testers'])] class extends Component {
    ...
    public function refreshVendors()
    {
        ...
        Cache::forget('store_vendors_data');
        $this->loadVendorsData();
    ...
    public function viewVendor($contactId)
    {
        ...
        // You can redirect to a view page: return redirect()->route('store.vendors.show', $contactId);
    }
    ...
    public function editVendor($contactId)
    {
        ...
        // You can redirect to an edit page: return redirect()->route('store.vendors.edit', $contactId);
    }
