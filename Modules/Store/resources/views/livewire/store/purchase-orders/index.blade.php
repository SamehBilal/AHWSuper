...
new #[Layout('store::components.layouts.admin', ['pageTitle' => 'Arabhardware | App Testers'])] class extends Component {
    ...
    public function loadPurchaseOrdersData()
    {
        try {
            ...
            $cacheKey = 'store_purchase_orders_data';
    ...
    public function refreshPurchaseOrders()
    {
        ...
        Cache::forget('store_purchase_orders_data');
        $this->loadPurchaseOrdersData();
    ...
    public function viewOrder($orderId)
    {
        ...
        // You can redirect to a view page: return redirect()->route('store.purchase-orders.show', $orderId);
    }
    ...
    public function editOrder($orderId)
    {
        ...
        // You can redirect to an edit page: return redirect()->route('store.purchase-orders.edit', $orderId);
    }
